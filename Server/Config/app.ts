...
// auth - define our auth objects
let localStrategy = passportLocal.Strategy; // alias

// auth - import the User Model
...
// create the application object of type express
const app = express();
...
// auth - setup Connect Flash
app.use(flash());

// auth - initialize passport and session
app.use(passport.initialize());
app.use(passport.session());

// auth - implement the auth strategy
passport.use(User.createStrategy());

// auth - setup User serialization and deserialization (encoding / decoding)
